...
// -------------------- Gemini Evaluation --------------------
export async function evaluateTask(input: EvaluateInput): Promise<EvaluationResult> {
...
export async function getRecentCommits(owner: string, repo: string, limit = 5): Promise<string[]> {
